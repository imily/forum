...
<section class="parallax-window" data-parallax="scroll" data-image-src="{{ URL::asset('images/production_pic.jpg') }}"></section>
        ...
        <ul class="characters-ul list-h">
            <li>
                <div class="box"  data-aos="fade-up" data-aos-delay="300">
                    <figure class="pic"><img itemprop="image" src="{{ URL::asset('images/characters/finch.jpg') }}" alt=""></figure>
            ...
            <li>
                <div class="box"  data-aos="fade-up" data-aos-delay="450">
                    <figure class="pic"><img itemprop="image" src="{{ URL::asset('images/characters/reese.jpg') }}" alt=""></figure>
            ...
            <li>
                <div class="box"  data-aos="fade-up" data-aos-delay="600">
                    <figure class="pic"><img itemprop="image" src="{{ URL::asset('images/characters/carter.jpg') }}" alt=""></figure>
            ...
            <li>
                <div class="box"  data-aos="fade-up" data-aos-delay="750">
                    <figure class="pic"><img itemprop="image" src="{{ URL::asset('images/characters/fusco.jpg') }}" alt=""></figure>
            ...
            <li>
                <div class="box"  data-aos="fade-up" data-aos-delay="900">
                    <figure class="pic"><img itemprop="image" src="{{ URL::asset('images/characters/shaw.jpg') }}" alt=""></figure>
            ...
            <li>
                <div class="box"  data-aos="fade-up" data-aos-delay="1050">
                    <figure class="pic"><img itemprop="image" src="{{ URL::asset('images/characters/root.jpg') }}" alt=""></figure>
                    <p class="name">Root</p>
...
<section class="photos" id="sect3">
    <ul class="photos-ul list-h">
        <li data-aos="fade" data-aos-delay="1100"><a data-fancybox="gallery" href="{{ URL::asset('images/photo/01_b.jpg') }}"><div class="text"><span><strong>S01E01</strong>Pilot</span></div><img src="{{ URL::asset('images/photo/01_s.jpg') }}"></a></li>
        <li data-aos="fade" data-aos-delay="1200"><a data-fancybox="gallery" href="{{ URL::asset('images/photo/02_b.jpg') }}"><div class="text"><span><strong>S01E08</strong>Foe</span></div><img src="{{ URL::asset('images/photo/02_s.jpg') }}"></a></li>
        <li data-aos="fade" data-aos-delay="1300"><a data-fancybox="gallery" href="{{ URL::asset('images/photo/03_b.jpg') }}"><div class="text"><span><strong>S02E01</strong>The Contingency</span></div><img src="{{ URL::asset('images/photo/03_s.jpg') }}"></a></li>
        <li data-aos="fade" data-aos-delay="1400"><a data-fancybox="gallery" href="{{ URL::asset('images/photo/04_b.jpg') }}"><div class="text"><span><strong>S02E16</strong>Relevance</span></div><img src="{{ URL::asset('images/photo/04_s.jpg') }}"></a></li>
        <li data-aos="fade" data-aos-delay="1500"><a data-fancybox="gallery" href="{{ URL::asset('images/photo/05_b.jpg') }}"><div class="text"><span><strong>S02E22</strong>God Mode</span></div><img src="{{ URL::asset('images/photo/05_s.jpg') }}"></a></li>
        <li data-aos="fade" data-aos-delay="1600"><a data-fancybox="gallery" href="{{ URL::asset('images/photo/06_b.jpg') }}"><div class="text"><span><strong>S03E06</strong>Mors Praematura</span></div><img src="{{ URL::asset('images/photo/06_s.jpg') }}"></a></li>
    </ul>
</section>
@endsection